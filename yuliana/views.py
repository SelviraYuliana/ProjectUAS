...
from yulianacart.models import Transaksi, DetailTransaksi
...
from yulianacart.forms import YulianacartAddProductForm
from yulianacart.keranjang import Yulianacart
...
def beranda(request):
    ...
    yulianacart_product_form = YulianacartAddProductForm()
    context = { 
                ...
                "slide": slider,
                "trending":trending,
                "yulianacart_product_form": yulianacart_product_form,
    }
